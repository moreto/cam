...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(title: 'Image Picker Demo', home: MyHomePage(title: 'Image Picker Example'));
  }
}
                  ...
                  switch (snapshot.connectionState) {
                    ...
                    case ConnectionState.active:
                      if (snapshot.hasError) {
                        return Text('Pick image/video error: ${snapshot.error}}', textAlign: TextAlign.center);
                      } else {
                        return const Text('You have not yet picked an image.', textAlign: TextAlign.center);
                      }
                  }
